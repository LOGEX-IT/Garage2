      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="{{url('/')}}">Accueil <i class="fa fa-chevron-right"></i></a></span> <span>Installation des équipements industriels <i class="fa fa-chevron-right"></i></span></p>
            <h1 class="mb-0 bread">Le montage et la pose des machines de production</h1>
          </div>
        </div>
      </div>
    </section>
...
Nous sommes à votre service au niveau national et international. Notre entreprise vous propose plusieurs prestations d’installation et de montage d’équipements industriels :</span>
            <h2>Nos services</h2>
          </div>
        </div>
