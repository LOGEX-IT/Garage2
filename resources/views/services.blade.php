      ...
      <div class="container">
          ...
          <div class="col-md-4 services ftco-animate">
            <div class="d-block d-flex">
              ...
              <div class="media-body pl-3">
                <h3 class="heading">Pièces détachées disponibles</h3>
          ...
          <div class="col-md-4 services ftco-animate">
            <div class="d-block d-flex">
              ...
              <div class="media-body pl-3">
                <h3 class="heading">Un service de Qualité</h3>
          ...
          <div class="col-md-4 services ftco-animate">
            <div class="d-block d-flex">
              ...
              <div class="media-body pl-3">
                <h3 class="heading">Entretien de véhicules</h3>
...
<div class="card col-12 col-lg-4 col-md-12">
  ...
  <div class="container">
    <h4><b>CAR WASH</b></h4>
    <p>Lavage à domicile ou au travail. Nous vous permettons tout en restant chez vous ou sur votre lieu travail, de faire nettoyer et entretenir votre véhicule sur place par une équipe de professionnels </p>
  </div>
</div> 
