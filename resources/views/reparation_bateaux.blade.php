...
.dropdown:hover .dropbtn {
  background-color: #f79f24;
    ...
    <!-- END nav -->
    <section class="hero-wrap hero-wrap-2" style="background-image: url('template/images/bateau1.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="{{url('/')}}">Accueil <i class="fa fa-chevron-right"></i></a></span> <span>Réparation de bateaux <i class="fa fa-chevron-right"></i></span></p>
            <h1 class="mb-0 bread">Réparation de bateaux</h1>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-md-4 services ftco-animate">
            <div class="d-block d-flex">
              ...
              <div class="media-body pl-3">
                <h3 class="heading">mécanique</h3>
                <p>révision, vidange, hivernage, dépose moteur, alignement, réfection d'hélice, arbre d'hélice, pose de propulseur d'étrave...</p>
          ...
          <div class="col-md-4 services ftco-animate">
            <div class="d-block d-flex">
              ...
              <div class="media-body pl-3">
                <h3 class="heading">coque</h3>
                <p>sablage, aérogommage, soudure, carénage, résine, traitement osmose, peinture au rouleau ou pistolet, antifouling, polissage...</p>
               <!--  <p><a href="#" class="btn-custom">Lire plus</a></p> -->
              </div>
            </div> 
          ...
          <div class="col-md-4 services ftco-animate">
            <div class="d-block d-flex">
              ...
              <div class="media-body pl-3">
                <h3 class="heading">intérieur</h3>
                <p>aménagement, menuiserie, plomberie, électricité, gaz (par installateur agréé), installation chauffage et climatisation...</p>
               <!--  <p><a href="#" class="btn-custom">Lire plus</a></p> -->
              </div>
            </div>
          ...
          <div class="col-md-4 services ftco-animate">
            <div class="d-block d-flex">
              ...
              <div class="media-body pl-3">
                <h3 class="heading">extérieur</h3>
                <p>taud, bimini, listons, arceau, plage de bain, main courante, bordé...</p>
                <!-- <p><a href="#" class="btn-custom">Lire plus</a></p> -->
              </div>
            </div>
          ...
          <div class="col-md-4 services ftco-animate">
            <div class="d-block d-flex">
              ...
              <div class="media-body pl-3">
                <h3 class="heading">nettoyage</h3>
                <p> intérieur/extérieur, haute pression, dégraissage moteur, déjaunissant coque, lustrage...</p>
               <!--  <p><a href="#" class="btn-custom">Lire plus</a></p> -->
              </div>
            </div> 
...
<div class="row justify-content-center" style="width: 100%;">
              <div class="card col-12 col-lg-6 col-md-12">
                <img style=""  src="{{ asset('template/images/bateau1.jpg') }}">
                <!-- <div class="container">
...
<div class="card col-12 col-lg-6 col-md-12">
  <img style="height: 300px;" src="{{ asset('template/images/bateau2.jpg') }}" alt="Avatar">
  <!-- <div class="container">
    <h4><b>L'INSTALLATION ET MAINTENANCE DE MATERIELS D'IMPRIMERIE</b></h4>
