...
.dropdown:hover .dropbtn {
  background-color: #f79f24;
    ...
    <!-- END nav -->
    <section class="hero-wrap hero-wrap-2" style="background-image: url('template/images/moto/bannerrentmoto.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="{{url('accueil')}}">Accueil <i class="fa fa-chevron-right"></i></a></span> <span>Location de moto <i class="fa fa-chevron-right"></i></span></p>
            <h1 class="mb-0 bread">Location de moto</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
          	<span class="subheading">Location de moto</span>
            <h2>Plusieurs moto de grandes marques à votre portée</h2>
          </div>
        </div>
				<div class="row">
					<div class="col-md-6 col-lg-4 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(template/images/moto/rentmoto/moto1.jpg);"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>yamaha</h3>
								<span class="position mb-2">50 000 FCFA TTC/mois</span>
								<!-- <div class="faded">
					...
					<div class="col-md-6 col-lg-4 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(template/images/moto/rentmoto/moto2.jpg);"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>Sanya</h3>
								<span class="position mb-2">25 000 FCFA TTC/mois</span>
								<!-- <div class="faded">
									<p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
									<ul class="ftco-social text-center">
						                <li class="ftco-animate"><a href="#" class="d-flex align-items-center justify-content-center"><span class="fa fa-twitter"></span></a></li>
					...
					<div class="col-md-6 col-lg-4 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(template/images/moto/rentmoto/moto3.jpg);"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>Haojue</h3>
								<span class="position mb-2">20 000 FCFA TTC/mois</span>
								<!-- <div class="faded">
									<p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
									<ul class="ftco-social text-center">
						                <li class="ftco-animate"><a href="#" class="d-flex align-items-center justify-content-center"><span class="fa fa-twitter"></span></a></li>
