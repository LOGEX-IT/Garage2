  ...
  background-color: #f79f24;
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="{{url('/')}}">Accueil <i class="fa fa-chevron-right"></i></a></span> <span>Boutique GNG <i class="fa fa-chevron-right"></i></span></p>
            <h1 class="mb-0 bread">Boutique GNG</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section">
          ...
          <div class="col-md-6 ftco-animate">
            <a href="{{URL::to('/carsale/')}}">
              <div class="work mb-6 img d-flex align-items-end" style="background-image: url(template/images/toyota.jpg);">
          ...
          <div class="col-md-6 ftco-animate">
            <a href="{{URL::to('/motosale/')}}">
              <div class="work mb-6 img d-flex align-items-end" style="background-image: url(template/images/haojue.jpg);">
               <p class=" image-popup d-flex justify-content-center align-items-center"></p>
               <div class="desc w-100 px-4">
                 <div class="text w-100 mb-3">
                    <span>Vente</span>
                    <h2>Moto</h2>
...
<!--         <div class="row mt-5">
    ...
    <section class="ftco-section">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 ftco-animate">
            <a href="{{URL::to('/rentcar/')}}">
              <div class="work mb-6 img d-flex align-items-end" style="background-image: url(template/images/nissan.jpg);">
