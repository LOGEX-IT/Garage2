...
.dropdown:hover .dropbtn {
  background-color: #f79f24;
    ...
    <!-- END nav -->
    <section class="hero-wrap hero-wrap-2" style="background-image: url('template/images/bgg.png');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="{{url('/')}}">Accueil <i class="fa fa-chevron-right"></i></a></span> <span>Installation d'imprimerie <i class="fa fa-chevron-right"></i></span></p>
            <h1 class="mb-0 bread">Installation d'imprimerie</h1>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-md-4 services ftco-animate">
            <div class="d-block d-flex">
              ...
              <div class="media-body pl-3">
                <h3 class="heading">L'installation et maintenance du matériel d'imprimerie</h3>
          ...
          <div class="col-md-4 services ftco-animate">
            <div class="d-block d-flex">
              ...
              <div class="media-body pl-3">
                <h3 class="heading">Rénovation, Réparation et maintenance de machine à papier</h3>
...
<div class="row justify-content-center" style="width: 100%;">
              <div class="card col-12 col-lg-6 col-md-12">
                <img style="" src="https://www.piaafrica.com/storage/listings/logos/57621_5c88f6d75a8ed-imprimerie1-cyan-cote-ivoire.png" alt="Avatar">
                <div class="container">
...
<div class="card col-12 col-lg-6 col-md-12">
  <img src="https://www.pressdepo.com/admin/UploadedFiles/Heidelberg_GTO_52_V_839782216_big.jpg" alt="Avatar">
  <div class="container">
    <h4><b>L'INSTALLATION ET MAINTENANCE DE MATERIELS D'IMPRIMERIE</b></h4>
